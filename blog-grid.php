...
<!-- Mirrored from demo.egenslab.com/html/buret/preview/skin-care/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Dec 2024 12:36:56 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
            ...
            <div class="sidebar-content-wrap">
                ...
                <ul class="contact-area">
                    ...
                    <li class="single-contact">
                        ...
                        <div class="content">
                            <span>EMAIL US</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#a1c8cfc7cee1c6ccc0c8cd8fc2cecc"><span class="__cf_email__" data-cfemail="d9b0b7bfb699beb4b8b0b5f7bab6b4">[email&#160;protected]</span></a></h6>
                        </div>
                    </li>
                    <li class="single-contact">
                        <div class="icon">
    ...
    <!-- Articel section strats here -->
    <div class="articel-section pt-120 mb-120">
        <div class="container">
            <div class="row gy-5 justify-content-center mb-70">
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="spa-blog-card">
                        <a href="blog-details.html" class="blog-image">
                            <img src="assets/image/beauty-spa/articel-image.png" alt="">
                        </a>
                        <div class="blog-content">
                            <ul class="blog-meta">
                                <li><a href="blog-grid.html">Facial Treatment</a></li>
                                <li><a class="publish-date" href="blog-grid.html">02 May, 2024</a></li>
                            </ul>
                            <h5><a href="blog-details.html">Fenty Beauty Pro Filt'r Soft Matte Longwear</a></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="spa-blog-card">
                        <a href="blog-details.html" class="blog-image">
                            <img src="assets/image/beauty-spa/articel-image2.png" alt="">
                        </a>
                        <div class="blog-content">
                            <ul class="blog-meta">
                                <li><a href="blog-grid.html">Bridal Spa</a></li>
                                <li><a class="publish-date" href="blog-grid.html">08 May, 2024</a></li>
                            </ul>
                            <h5><a href="blog-details.html">Fenty Beauty Pro Filt'r Soft
                                    Matte Longwear</a></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="spa-blog-card">
                        <a href="blog-details.html" class="blog-image">
                            <img src="assets/image/beauty-spa/articel-image3.png" alt="">
                        </a>
                        <div class="blog-content">
                            <ul class="blog-meta">
                                <li><a href="blog-grid.html">Eyelach Extension</a></li>
                                <li><a class="publish-date" href="blog-grid.html">02 May, 2024</a></li>
                            </ul>
                            <h5><a href="blog-details.html">Fenty Beauty Pro Filt'r Soft
                                    Matte Longwear</a></h5>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div class="spa-blog-card">
                        <a href="blog-details.html" class="blog-image">
                            <img src="assets/image/beauty-spa/blog-gride/articel-image4.png" alt="">
                        </a>
                        <div class="blog-content">
                            <ul class="blog-meta">
                                <li><a href="blog-grid.html">Body Waxing</a></li>
                                <li><a class="publish-date" href="blog-grid.html">07 May, 2024</a></li>
                            </ul>
                            <h5><a href="blog-details.html">discover the power of natural ingredients in beauty.</a></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div class="spa-blog-card">
                        <a href="blog-details.html" class="blog-image">
                            <img src="assets/image/beauty-spa/blog-gride/articel-image5.png" alt="">
                        </a>
                        <div class="blog-content">
                            <ul class="blog-meta">
                                <li><a href="blog-grid.html">Eyelach Extension</a></li>
                                <li><a class="publish-date" href="blog-grid.html">15 May, 2024</a></li>
                            </ul>
                            <h5><a href="blog-details.html">the benefits of spa therapies for relaxation.</a></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="spa-blog-card">
                        <a href="blog-details.html" class="blog-image">
                            <img src="assets/image/beauty-spa/blog-gride/articel-image6.png" alt="">
                        </a>
                        <div class="blog-content">
                            <ul class="blog-meta">
                                <li><a href="blog-grid.html">Bridal Spa</a></li>
                                <li><a class="publish-date" href="blog-grid.html">18 May, 2024</a></li>
                            </ul>
                            <h5><a href="blog-details.html">transformative beauty tips for special occasions</a></h5>
                        </div>
                    </div>
                </div>
            </div>
