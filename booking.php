...
<!-- Mirrored from demo.egenslab.com/html/buret/preview/skin-care/booking.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Dec 2024 12:36:56 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
            ...
            <div class="sidebar-content-wrap">
                ...
                <ul class="contact-area">
                    ...
                    <li class="single-contact">
                        ...
                        <div class="content">
                            <span>EMAIL US</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#a3cacdc5cce3c4cec2cacf8dc0ccce"><span class="__cf_email__" data-cfemail="dab3b4bcb59abdb7bbb3b6f4b9b5b7">[email&#160;protected]</span></a></h6>
                        </div>
                    </li>
                    <li class="single-contact">
                        <div class="icon">
    ...
    <div class="skin-header-topbar-wrap booking-page">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10">
                    <div class="enquery-form-wrapper style-2 booking-form">
                        <form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-30">
                                    <div class="form-inner">
                                        <label>Choose Desired Service</label>
                                        <select>
