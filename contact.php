...
<!-- Mirrored from demo.egenslab.com/html/buret/preview/skin-care/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Dec 2024 12:36:56 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="sidebar-content-wrap">
                ...
                <ul class="contact-area">
                    ...
                    <li class="single-contact">
                        ...
                        <div class="content">
                            <span>EMAIL US</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#066f68606946616b676f6a2865696b"><span class="__cf_email__" data-cfemail="caa3a4aca58aada7aba3a6e4a9a5a7">[email&#160;protected]</span></a></h6>
                        </div>
                    </li>
                    <li class="single-contact">
                        <div class="icon">
        ...
        <div class="container">
            <div class="row gy-4 justify-content-center mb-70">
                <div class="col-xl-8 col-lg-10">
                    <div class="contact-from-top-section">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="address-line-section">
                                    <h4>address line</h4>
                                    <p>Barkinghum
                                        123 Main Street, Suite 200 Plattsburgh, New York 12345, USA</p>
                                    <a class="primary-btn4 direction-btn" href="https://www.google.com/maps/place/Egens+Lab/@23.8340712,90.3631117,17z/data=!3m1!4b1!4m6!3m5!1s0x3755c14c8682a473:0xa6c74743d52adb88!8m2!3d23.8340663!4d90.3656866!16s%2Fg%2F11rs9vlwsk?entry=ttu&amp;g_ep=EgoyMDI0MDgyOC4wIKXMDSoASAFQAw%3D%3D">
                                        MAP DIRECTION
                                        <svg class="arrow" width="10" height="10" viewBox="0 0 10 10"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9" stroke-width="1.5" stroke-linecap="round"></path>
                                        </svg>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="opening-hours-section">
                                    <h4>opening hours</h4>
                                    <ul>
                                        <li>Sat - Tue (9AM - 7PM)</li>
                                        <li>Wed - Thu (8AM - 6PM)</li>
                                        <li>Sunday- CLOSED</li>
                                    </ul>
                                    <a class="primary-btn4 appointment-btn" href="booking.html">
                                        BOOK APPOINTMENT
                                        <svg class="arrow" width="10" height="10" viewBox="0 0 10 10"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
