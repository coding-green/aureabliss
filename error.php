...
<!-- Mirrored from demo.egenslab.com/html/buret/preview/skin-care/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Dec 2024 12:36:56 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
            ...
            <div class="sidebar-content-wrap">
                ...
                <ul class="contact-area">
                    ...
                    <li class="single-contact">
                        ...
                        <div class="content">
                            <span>EMAIL US</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#0d64636b624d6a606c6461236e6260"><span class="__cf_email__" data-cfemail="f39a9d959cb3949e929a9fdd909c9e">[email&#160;protected]</span></a></h6>
                        </div>
                    </li>
                    <li class="single-contact">
                        <div class="icon">
    ...
    <div class="skin-header-topbar-wrap error-page">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item-has-children active">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="error.html">Error</a></li>
                        </ul>
                    </li>
    ...
    <!-- Strats error section -->
    <div class="error-section pt-120 mb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="error-wrapper text-center">
                        <div class="error-img mb-30">
                            <img src="assets/image/hair-salon/error/404.png" alt="">
                        </div>
                        <div class="error-content  style-2">
                            <h1>opps! page not found</h1>
                            <p>There is a technical issue on our end.</p>
                            <div class="back-btn">
                                <a class="primary-btn1 error-btn" href="index.html">
                                    GO TO HOMEPAGE
