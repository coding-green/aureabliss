...
<!-- Mirrored from demo.egenslab.com/html/buret/preview/skin-care/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Dec 2024 12:36:56 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
            ...
            <div class="sidebar-content-wrap">
                ...
                <ul class="contact-area">
                    ...
                    <li class="single-contact">
                        ...
                        <div class="content">
                            <span>EMAIL US</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#50393e363f10373d31393c7e333f3d"><span class="__cf_email__" data-cfemail="670e09010827000a060e0b4904080a">[email&#160;protected]</span></a></h6>
                        </div>
                    </li>
                    <li class="single-contact">
                        <div class="icon">
    ...
    <div class="faq-section style-2 pt-120 mb-120">
        <div class="container">
                    ...
                    <div class="faq-area">
                        <div class="faq-wrap">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <div class="accordion-item style-2">
    ...
    <div class="offer-section mb-120"
        style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)), url(assets/image/beauty-spa/faq/discount-image4.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="offer-content style-2 text-center">
                        <span class="offer-tag">SAFETY & HYGINENE</span>
                        <h2 class="eb-text-font">100% ensure safety & hygiene</h2>
                        <ul class="offer-list">
                            <li>
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="9" cy="9" r="9" fill="#E5E342" />
                                    <mask id="mask0_1233_689" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="4"
                        ...
                        <a class="primary-btn1 service-btn2" href="services-details.html">
                            VIEW SERVICE MENU
                            <svg class="arrow" width="10" height="10" viewBox="0 0 10 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9"
