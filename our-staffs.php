...
<!-- Mirrored from demo.egenslab.com/html/buret/preview/skin-care/our-staffs.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Dec 2024 12:36:48 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
            ...
            <div class="sidebar-content-wrap">
                ...
                <ul class="contact-area">
                    ...
                    <li class="single-contact">
                        ...
                        <div class="content">
                            <span>EMAIL US</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#640d0a020b240309050d084a070b09"><span class="__cf_email__" data-cfemail="fe97909891be99939f9792d09d9193">[email&#160;protected]</span></a></h6>
                        </div>
                    </li>
                    <li class="single-contact">
                        <div class="icon">
        ...
        <header class="header-area skin-care inner-page">
            ...
            <div class="main-menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item-has-children"><a class="drop-down" href="#">SKIN CARE</a><i
                    ...
                    <li class="menu-item-has-children active">
                        ...
                        <ul class="sub-menu">
                            <li class="active"><a href="our-staffs.html">Our Staff</a></li>
    ...
    <!-- team section strats here -->
    <div class="team-modal review-modal modal fade" id="teamModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-5">
                            <div class="team-image">
                                <img src="assets/image/beauty-spa/our-staf/staf-image.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="team-content">
                                <div class="name-deg style-2">
                                    <h5>Fiona Penelope</h5>
                                    <span>Salon Manager</span>
                                </div>
                                <p>I am a passionate and dedicated beauty specialist with
                                    <strong>10 years / 7 months</strong> of experience in the skincare and beauty
                                    industry. I have a strong commitment to helping clients achieve their beauty goals
                                    and feel confident in their own skin. My expertise lies in providing a range of
                                    <strong>Hair Style, Makeup Services,</strong> and <strong>Nail Care</strong>
                                    procedures tailored to meet individual needs.
                                </p>
    ...
    <div class="our-team-section style-2 pt-120 mb-120">
        <div class="container">
            <div class="row gy-4 justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="team-card">
                        <div class="team-image">
                            <img src="assets/image/beauty-spa/our-staf/staf-image.png" alt="">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#teamModal">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="team-card">
                        <div class="team-image">
                            <img src="assets/image/beauty-spa/our-staf/staf-image2.png" alt="">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#teamModal">
                                <i class="bi bi-plus"></i>
                            </button>
                        </div>
                        <div class="team-content text-center">
                            <h5>Daniel Christopher</h5>
                            <span>Senior Hairstylist</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="team-card">
                        <div class="team-image">
                            <img src="assets/image/beauty-spa/our-staf/staf-image3.png" alt="">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#teamModal">
                                <i class="bi bi-plus"></i>
                            </button>
                        </div>
                        <div class="team-content text-center">
                            <h5>mrs. eva sophia</h5>
                            <span>Senior Stylist</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div class="team-card">
                        <div class="team-image">
                            <img src="assets/image/beauty-spa/our-staf/staf-image4.png" alt="">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#teamModal">
                                <i class="bi bi-plus"></i>
                            </button>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="team-card">
                        <div class="team-image">
                            <img src="assets/image/beauty-spa/our-staf/staf-image5.png" alt="">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#teamModal">
                                <i class="bi bi-plus"></i>
                            </button>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="team-card">
                        <div class="team-image">
                            <img src="assets/image/beauty-spa/our-staf/staf-image6.png" alt="">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#teamModal">
                                <i class="bi bi-plus"></i>
                            </button>
                        </div>
    ...
    <div class="spa-offer-section style-3 mb-120"
        style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)), url(assets/image/beauty-spa/all-treatment3/special-offer-image3.jpg);">
        <div class="container">
            <div class="row justify-content-lg-end">
                <div class="col-xxl-3 col-lg-4 d-flex justify-content-lg-end">
                    <div class="opening-time-area wow animate fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <h6>Opening Hours</h6>
                        <ul>
                            <li><span>Sat - Tue</span> <span>10AM - 7PM</span></li>
                            <li><span>Wed - Thu</span> <span>8AM - 6PM</span></li>
                            <li><span>Sunday</span> <span>CLOSED</span></li>
                        </ul>
                        <h6>Phone</h6>
                        <a href="tel:+99078377854">+99(0) 783 778 54</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-7 col-lg-8 d-flex justify-content-end wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="spa-offer-content">
                        <h2>every new customer has
                            been <span>50% discount</span> to every
                            single service package.</h2>
                        <a class="primary-btn4 service-menu-btn" href="services-details.html">
                            VIEW SERVICE MENU
                    ...
                    <div class="enquery-form-wrapper style-2">
                        <form>
                            <div class="form-title mb-60">
                                <h2>to more enquiry</h2>
                                <p>We believe in the transformative power of relaxation and self-care. Nestled in the
                                    heart of UK.</p>
                            </div>
                            <div class="row">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="single-gallery-img">
                        ...
                        <img src="assets/image/beauty-spa/gallery-image.png" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="single-gallery-img">
                        ...
                        <img src="assets/image/beauty-spa/gallery-image2.png" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="single-gallery-img">
                        ...
                        <img src="assets/image/beauty-spa/gallery-image3.png" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="single-gallery-img">
                        ...
                        <img src="assets/image/beauty-spa/gallery-image4.png" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="single-gallery-img">
                        ...
                        <img src="assets/image/beauty-spa/gallery-image5.png" alt="">
                    </div>
                </div>
            </div>
        </div>
