...
<!-- Mirrored from demo.egenslab.com/html/buret/preview/skin-care/services01.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Dec 2024 12:36:44 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
            ...
            <div class="sidebar-content-wrap">
                ...
                <ul class="contact-area">
                    ...
                    <li class="single-contact">
                        ...
                        <div class="content">
                            <span>EMAIL US</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#6900070f06290e04080005470a0604"><span class="__cf_email__" data-cfemail="fb92959d94bb9c969a9297d5989496">[email&#160;protected]</span></a></h6>
                        </div>
                    </li>
                    <li class="single-contact">
                        <div class="icon">
            ...
            <div class="main-menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item-has-children active"><a class="drop-down" href="#">SKIN CARE</a><i
                        ...
                        <ul class="sub-menu">
                            <li class="active"><a href="services01.html">Services-01</a></li>
    ...
    <!-- Service section strats here -->
    <div class="skin-care-service pt-120 mb-120">
        <div class="container">
            <div class="row gy-5">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="skin-care-service-card">
                        <a href="services-details.html" class="service-image">
                            <img src="assets/image/skin-care/service-image8.png" alt="">
                        </a>
                        <div class="service-content">
                            <a href="services01.html">Add-On</a>
                            <h5><a href="services-details.html">Add-On Services</a></h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="spa-offer-banner-section style-2 mb-120">
        <div class="spa-offer-content">
            <span>50% DISCOUNT</span>
            <h2>every new customer has been <span>50% discount</span> to every
        ...
        <ul class="spa-banner-img-group">
            <li class="single-banner-bg" id="background-panel-0"
                style="background: linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url('assets/image/beauty-spa/all-treatment2/special-offer-image.jpg');">
            </li>
            <li class="single-banner-bg" id="background-panel-1"
                style="background: linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url('assets/image/beauty-spa/all-treatment2/special-offer-image2.jpg');">
            </li>
            <li class="single-banner-bg" id="background-panel-2"
                style="background: linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), url('assets/image/beauty-spa/all-treatment2/special-offer-image3.jpg');">
            </li>
        </ul>
        <ul class="spa-sm-img-list">
            <li class="single-item" data-show="#background-panel-0">
                <div class="banner-sm-img active">
                    <img src="assets/image/beauty-spa/all-treatment2/special-offer-sm-image.png" alt="">
                </div>
            </li>
            <li class="single-item" data-show="#background-panel-1">
                <div class="banner-sm-img">
                    <img src="assets/image/beauty-spa/all-treatment2/special-offer-sm-image2.png" alt="">
                </div>
            </li>
            <li class="single-item" data-show="#background-panel-2">
                <div class="banner-sm-img">
                    <img src="assets/image/beauty-spa/all-treatment2/special-offer-sm-image3.png" alt="">
                </div>
            </li>
        </ul>
    </div>
            ...
            <div class="row gy-4">
                <div class="col-lg-6 d-flex align-items-center wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="skin-care-section-title text-center">
                        ...
                        <h2 class="style-2">Skin protection</h2>
                ...
                <div class="col-lg-6 position-relative wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                    ...
                    <div class="faq-area">
                        <div class="faq-wrap">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                ...
                                <div class="accordion-item wow animate fadeInUp" data-wow-delay="350ms" data-wow-duration="1500ms">
                                ...
                                <div class="accordion-item wow animate fadeInUp" data-wow-delay="650ms" data-wow-duration="1500ms">
                                ...
                                <div class="accordion-item wow animate fadeInUp" data-wow-delay="950ms" data-wow-duration="1500ms">
...
<!-- Mirrored from demo.egenslab.com/html/buret/preview/skin-care/services01.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Dec 2024 12:36:45 GMT -->
</html>